...
namespace PowerPoint.Model
{
    public class Circle : Shape
    {
        ...
        public Circle(CoordinatePoint upperLeftPoint, CoordinatePoint lowerRightPoint)
        {
        ...
        public override void Draw(IGraphics graphics)
        {
            if (_width < 0 && _height < 0)
                graphics.DrawCircle(_lowerRightPoint, -_width, -_height);
            else if (_width < 0 && _height > 0)
                graphics.DrawCircle(new CoordinatePoint(_lowerRightPoint.GetPointX(), _upperLeftPoint.GetPointY()), -_width, _height);
            else if (_width > 0 && _height < 0)
                graphics.DrawCircle(new CoordinatePoint(_upperLeftPoint.GetPointX(), _lowerRightPoint.GetPointY()), _width, -_height);
            else
                graphics.DrawCircle(_upperLeftPoint, _width, _height);
        }
